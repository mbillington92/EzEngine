...
Q: How far along in development is EZEngine?
...
Q: Will there be Interop libraries for other frameworks or libraries, and base libraries for other languages?

A: There are no plans for that at this time, presently only MonoGame support is expected.


Q: Why does this ignore the content management pipeline built into MonoGame?
...
Q: Why not just use Unity/Godot/Pure MonoGame/any other engine?
...
Q: What license is EZEngine under?
...
Q: Can I use the included maps/models/textures in my own public projects?
...
Q: What dependencies does EZEngine have?
...
Q: Will PolyOne3 or P13DDK ever be open source?
...
Q: Can I get in contact? I need to report a bug, suggest an idea or tell you about some of your code I've reviewed and which could use some improvement.

A: I'm not open to this right now, but may provide options in the future.


Q: Can I contribute to the development of EZEngine?
